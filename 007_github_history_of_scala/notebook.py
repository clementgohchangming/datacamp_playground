...
pulls['date'] = pulls['date'].apply(lambda x: pd.to_datetime(x, utc=True))

print("pulls after conversion")
print(pulls.head())
...
print("data after merging pulls and pull_files")
print(data.head())
...
# pulls.sort_values(by = 'date', ascending=False).head(10)
